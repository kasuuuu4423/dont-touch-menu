...
if(isset($_SESSION['USERID'])){
  ...
  if(isset($_SESSION['seats_inCtrl_msg'])){
    echo '<div class="mt-3 w-100 text-center update_msg"><span>'.$_SESSION['seats_inCtrl_msg'].'</span></div>';
    unset($_SESSION['seats_inCtrl_msg']);
  }
  else if(isset($_SESSION['leave_inCtrl_msg'])){
    echo '<div class="mt-3 w-100 text-center update_msg"><span>'.$_SESSION['leave_inCtrl_msg'].'</span></div>';
