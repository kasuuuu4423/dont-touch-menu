...
$ctrl_js_path               = $root_path . '/control/assets/js/';
$ctrl_signup_path           = $root_path . '/control/signup/';
$ctrl_login_path            = $root_path . '/control/login/';
$ctrl_logout_path           = $root_path . '/control/logout/';
$ctrl_update_store_path     = $root_path . '/control/update_store/';
$ctrl_update_menu_path      = $root_path . '/control/update_menu/';
$ctrl_update_rule_path      = $root_path . '/control/update_rule/';
